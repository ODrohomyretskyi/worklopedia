...
export class CreateUserSettingAndBlockListTables1702309905286
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "block_list" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "blocked_user_id" character varying NOT NULL, "owner_id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2d5483a1c23eab6a21c8f4792c3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "UQ_c734474c3f967b9d81951079d36" UNIQUE ("userSettingId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_c734474c3f967b9d81951079d36" FOREIGN KEY ("userSettingId") REFERENCES "user_setting"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_c734474c3f967b9d81951079d36"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "UQ_c734474c3f967b9d81951079d36"`,
    );
